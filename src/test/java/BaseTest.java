...
//        Click the Login button
    ...
    public void renamePlaylist(String x) {
        WebElement e = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("[name='name']")));
        e.sendKeys(Keys.chord(Keys.CONTROL, "A", Keys.BACK_SPACE));
        e.sendKeys(x);
